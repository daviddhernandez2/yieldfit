...
// Al hacer click, dispara la reproducción de la intro si está expuesta a nivel
// global (definida en App.jsx). Sirve como Easter egg y como demo rápida
// del intro sin necesidad de cerrar sesión.
export default function Logo({ width = 200, className }) {
  const handleClick = () => {
    if (typeof window !== 'undefined' && window.__yieldfitReplayIntro) {
      window.__yieldfitReplayIntro();
    }
  };
